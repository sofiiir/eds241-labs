...
author: "Sofia Rodas EDS 241 / ESM 244"
format:
  html:
    theme: sketchy
    css: styles.css
...
The increase in vpd between the two models shows that plots were convoluting the true effects of vapor pressure deficit on the percent increase in rust disease. The effect of VPD is larger than was originally calculated without taking into account differences in plots and year.
